...
# -*- coding: utf-8 -*-
"""
Master-Runner für Winterthur Stadtbaum v7
=========================================
...
Beispiel:
    python scripts/run_winterthur_scenarios_v7.py --scenario_config configs/scenario_grid_v7.yaml
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Startet viele Winterthur-v7-Szenarien und aggregiert Ergebnisse.")
    ap.add_argument("--scenario_config", required=True, help="YAML-Datei mit base/grid/runs.")
    ap.add_argument("--script", default=None, help="Pfad zum v7-Modellskript. Überschreibt Wert aus YAML.")
    ...
    script = Path(args.script or cfg.get("script", "scripts/winterthur_tree_stochastic_goal_planning_v7.py"))

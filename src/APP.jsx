...
const AMBER="#c8860d",BARK="#9a9890",BRICK="#a32d2d",TEXT_MUTE="#7a786f";
const GREEN="#3b6d11";
...
/* Katasterbasierte Baumarten-Zusammensetzung mit Klimaergänzung.
   Generiert aus 2026-04-13_Baumkataster_gesamte_Daten.csv, species_life_ranges.csv,
   citytrees2_scores.csv, TreeGOER_2023_wide.csv und CitiesGOER-Winterthur-Szenarien.
   climateFitByScenario kombiniert CityTrees-II + TreeGOER bio05_q95/qrt3 + Proxywerte. */
const SPECIES_BASE=[
  {
    "name": "Tilia europaea",
    "label": "Linde / Holländische Linde",
    "count": 1414,
    "fallen": 358.0,
    "avgAge": 43.3,
    "lifeMin": 60.0,
  ...
  },
  {
    ...
    "treeBio05Q75": 27.0,
    "cityTreesFit": 0.59,
    "climateSource": "TreeGOER+CityTrees",
    "risk": 0.77
  },
  {
  ...
  },
  {
    ...
    "label": "Rotblühende Rosskastanie. gefüllte",
    "count": 105,
    "fallen": 27.0,
    "avgAge": 34.9,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Japanische Zierkirsche. Higan-Kirsche",
    "count": 99,
    "fallen": 8.0,
    "avgAge": 19.8,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Katsurabaum. Japanischer Kuchenbaum",
    "count": 59,
    "fallen": 9.0,
    "avgAge": 37.7,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Kultur-Pflaume. Zwetschge",
    "count": 54,
    "fallen": 19.0,
    "avgAge": 12.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "0_UNBESTIMMT wird nachgetragen",
    "label": "0_UNBESTIMMT",
    "count": 46,
    "fallen": 14.0,
    "avgAge": 25.6,
  ...
  {
    "name": "Fraxinus excelsiors Glorie'",
    "label": "Esche Westhof's Glorie",
    "count": 44,
    "fallen": 20.0,
    "avgAge": 18.3,
    "lifeMin": 90.0,
  ...
  {
    "name": "Acer palmatum",
    "label": "Japanischer Ahorn. Fächer-Ahorn",
    "count": 40,
    "fallen": 4.0,
    "avgAge": 55.7,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Schwedische Mehlbeere. Oxelbeere",
    "count": 38,
    "fallen": 22.0,
    "avgAge": 12.2,
    "lifeMin": 90.0,
  ...
  {
    "name": "Cornus mas",
    "label": "Kornelkirsche. Tierlibaum",
    "count": 33,
    "fallen": 12.0,
    "avgAge": 55.6,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Lederblättriger Weissdorn",
    "count": 30,
    "fallen": 258.0,
    "avgAge": 26.5,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Esskastanie. Edelkastanie",
    "count": 27,
    "fallen": 3.0,
    "avgAge": 5.6,
    "lifeMin": 70.0,
  ...
  {
    "name": "Alnus cordata",
    "label": "Italienische Erle. Herzblättrige Erle",
    "count": 20,
    "fallen": 18.0,
    "avgAge": 36.2,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Kanadische Hemlockstanne",
    "count": 19,
    "fallen": 13.0,
    "avgAge": 61.7,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Felsenahorn. Französischer Ahorn",
    "count": 18,
    "fallen": 2.0,
    "avgAge": 15.6,
    "lifeMin": 90.0,
  ...
  {
    "name": "Pinus nigra ssp. nigra",
    "label": "Österreichische Scharzkiefer",
    "count": 16,
    "fallen": 4.0,
    "avgAge": 60.8,
    "lifeMin": 90.0,
  ...
  {
    "name": "Acer opalus Mill.",
    "label": "Schneeballblättriger Ahorn",
    "count": 15,
    "fallen": 5.0,
    "avgAge": 2.1,
    "lifeMin": 90.0,
  ...
  {
    "name": "Pyrus communis var. sativa",
    "label": "Kultursorten",
    "count": 12,
    "fallen": 25.0,
    "avgAge": 43.7,
  ...
  {
    "name": "Aesculus flava",
    "label": "Gelbe Pavie. Gelbe Rosskastanie",
    "count": 11,
    "fallen": 4.0,
    "avgAge": 32.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Zweigriffeliger Weissdorn",
    "count": 10,
    "fallen": 42.0,
    "avgAge": 26.8,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Taubenbaum. Taschentuchbaum",
    "count": 8,
    "fallen": 37.0,
    "avgAge": 43.2,
    "lifeMin": 90.0,
  ...
  {
    "name": "Salix x sepulcralis",
    "label": "Echte Trauer-Weide",
    "count": 8,
    "fallen": 2.0,
    "avgAge": 6.2,
    "lifeMin": 90.0,
  ...
  {
    "name": "Toona sinensis",
    "label": "Surenbaum. Chinesischer Gemüsebaum",
    "count": 8,
    "fallen": 2.0,
    "avgAge": 40.9,
    "lifeMin": 90.0,
  ...
  {
    "name": "Ulmus hollandica",
    "label": "Holländische Ulme",
    "count": 7,
    "fallen": 2.0,
    "avgAge": 5.0,
    "lifeMin": 98.0,
  ...
  {
    "name": "Magnolia",
    "label": "Tulpen-Magnolie Heaven Scent",
    "count": 6,
    "fallen": 0.0,
    "avgAge": 16.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Quercus macranthera",
    "label": "Persische Eiche",
    "count": 6,
    "fallen": 0.0,
    "avgAge": 57.7,
    "lifeMin": 90.0,
  ...
  {
    "name": "Ulmus New Horizon",
    "label": "Ulme Resistent",
    "count": 6,
    "fallen": 1.0,
    "avgAge": 7.8,
    "lifeMin": 90.0,
  ...
  {
    "name": "Malus tschonoskii",
    "label": "Scharlach Apfel",
    "count": 4,
    "fallen": 0.0,
    "avgAge": 1.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Betula albosinensis",
    "label": "Rote China-Birke",
    "count": 3,
    "fallen": 0.0,
    "avgAge": 23.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Prächtiger Trompetenbaum",
    "count": 3,
    "fallen": 0.0,
    "avgAge": 25.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Steppenkirsche. Zwerg-Kirsche",
    "count": 3,
    "fallen": 0.0,
    "avgAge": 18.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Prunus umineko",
    "label": "Japanische Säulenkirsche",
    "count": 3,
    "fallen": 2.0,
    "avgAge": 14.3,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Abendländischer Lebensbaum",
    "count": 3,
    "fallen": 8.0,
    "avgAge": 68.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Acer tataricum",
    "label": "Tatarischer Steppen-Ahorn",
    "count": 2,
    "fallen": 5.0,
    "avgAge": 26.5,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Kegelförmige Sawara Scheinzypresse",
    "count": 2,
    "fallen": 6.0,
    "avgAge": 82.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Fagus sylvatica cuprea/purpurea",
    "label": "Blutbuche",
    "count": 2,
    "fallen": 1.0,
    "avgAge": 152.0,
  ...
  {
    "name": "Juglans mandshurica Maxim",
    "label": "Mandschurische Walnuss",
    "count": 2,
    "fallen": 0.0,
    "avgAge": 131.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Laburnum vulgare",
    "label": "Einheimischer Goldregen",
    "count": 2,
    "fallen": 6.0,
    "avgAge": 37.5,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Kriechende Haferschlehe. Kriechen-Pflaume",
    "count": 2,
    "fallen": 5.0,
    "avgAge": 63.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Amerikanische / Spätblühende Traubenkirsche",
    "count": 2,
    "fallen": 2.0,
    "avgAge": 21.5,
    "lifeMin": 90.0,
  ...
  {
    "name": "Abies concolor",
    "label": "Kolorado-Tanne. Grau-Tanne",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 76.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Hainbuchenblättriger Ahorn",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 7.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Acer platanoides \"Allershausen\"",
    "label": "Spitzahorn Allershausen",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 0.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Acer platanoides \"Norwegian Sunset\"",
    "label": "Acer platanoides \"Norwegian Sunset\"",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 0.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Chinesischer Schneeflockenstrauch",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 16.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Etagen Hartriegel. Pagoden-Hartriegel",
    "count": 1,
    "fallen": 1.0,
    "avgAge": 50.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Eucommia ulmoides",
    "label": "Guttaperchabaum",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 3.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Pfaffenhütchen. Gewöhnlicher Spindelstrauch",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 18.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Fagus sylvatica Purpurea Pendula'",
    "label": "Schwarzrote Hänge-Buche",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 35.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Antarktische Scheinbuche",
    "count": 1,
    "fallen": 10.0,
    "avgAge": 9.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Robinia x ambigua",
    "label": "Robinie. Scheinakazie",
    "count": 1,
    "fallen": 1.0,
    "avgAge": 75.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Babylon-Weide. Echte Trauerweide",
    "count": 1,
    "fallen": 2.0,
    "avgAge": 67.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Sorbus x thuringiaca",
    "label": "Thüringische Mehlbeere",
    "count": 1,
    "fallen": 1.0,
    "avgAge": 5.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Morgenländischer Lebensbaum",
    "count": 1,
    "fallen": 1.0,
    "avgAge": 27.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Tilia cordata `Böhlje`",
    "label": "Winterlinde `Böhlje",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 8.0,
    "lifeMin": 90.0,
  ...
  {
    "name": "Tilia dasystyla",
    "label": "Kaukaische-Linde",
    "count": 1,
    "fallen": 0.0,
    "avgAge": 64.0,
    "lifeMin": 90.0,
  ...
  },
  {
    ...
    "label": "Heimischer Hartriegel. Roter Hartriegel",
    "count": 1,
    "fallen": 10.0,
    "avgAge": 18.0,
    "lifeMin": 90.0,
...
const SPECIES_DATASET = {
  ...
  lifeCoverage: 0.763,
  treegoerCoveredActive: 7464,
  treegoerCoverage: 0.449,
  citytreesCoveredActive: 11357,
  citytreesCoverage: 0.683,
  source: "Baumkataster 2026-04-13 + species_life_ranges.csv + CityTrees-II + TreeGOER + CitiesGOER + GreenList_25_D Östliches Mittelland",
};

const SPECIES_NOTE="Katasterbasierte Artansicht mit Klimaergänzung: aktuelle Artanteile, historische Fällungen und mittleres Alter stammen aus dem Baumkataster 2026-04-13. Lebensdauerwerte stammen aus species_life_ranges.csv. Der Klima-Fit kombiniert, wo verfügbar, CityTrees-II (Urban-/Trockenheits-/Hitze-Eignung), TreeGOER (bio05-Wärmegrenze der Art) und CitiesGOER-Zukunftsklima für Winterthur. Abdeckung: TreeGOER 44.9 % der aktiven Bäume, CityTrees-II 68.3 %. Die Herkunftsklassierung Einheimisch/Nicht einheimisch basiert neu auf GreenList_25_D.xlsx: Arten mit Markierung X in der Spalte Östliches Mittelland gelten im Dashboard als einheimisch; eindeutige Kultivare/Hybride einheimischer Elternarten werden entsprechend zugeordnet. Nicht gefundene Arten werden als nicht einheimisch bzw. ohne GreenList-Treffer geführt.";

/* Herkunft / Einheimischkeit: GreenList 2025, Bioregion Östliches Mittelland.
   Im Dashboard gilt: Markierung "X" in GreenList_25_D.xlsx / Artempfehlungen /
   Spalte "Östliches Mittelland" = Einheimisch im Sinn der Bioregion.
   Kultivare werden auf die zugrundeliegende Art reduziert. Wenige eindeutige
   Synonyme/Hybride einheimischer Elternarten werden manuell gleichgesetzt. */
const GREENLIST_OSTMITTELLAND_CORES = new Set([
  "Abies alba", "Acer campestre", "Acer platanoides", "Acer pseudoplatanus",
  "Achillea millefolium", "Acinos arvensis", "Aconitum lycoctonum", "Actaea spicata",
  "Adoxa moschatellina", "Aegopodium podagraria", "Aethusa cynapium", "Agrimonia eupatoria",
  "Agrostis canina", "Agrostis capillaris", "Agrostis gigantea", "Agrostis stolonifera",
  "Ajuga genevensis", "Ajuga reptans", "Alchemilla xanthochlora", "Alisma plantago-aquatica",
  "Alliaria petiolata", "Allium oleraceum", "Allium schoenoprasum", "Allium ursinum",
  "Allium vineale", "Alnus glutinosa", "Alnus incana", "Alopecurus myosuroides",
  "Alopecurus pratensis", "Amelanchier ovalis", "Anagallis arvensis", "Anchusa officinalis",
  "Anemone nemorosa", "Anemone ranunculoides", "Angelica sylvestris", "Anthoxanthum odoratum",
  "Anthriscus sylvestris", "Anthyllis vulneraria", "Apera spica-venti", "Aphanes arvensis",
  "Aquilegia atrata", "Aquilegia vulgaris", "Arabidopsis thaliana", "Arabis hirsuta",
  "Arctium lappa", "Arenaria serpyllifolia", "Armoracia rusticana", "Arrhenatherum elatius",
  "Artemisia absinthium", "Artemisia vulgaris", "Arum maculatum", "Aruncus dioicus",
  "Asarum europaeum", "Asperula cynanchica", "Asplenium ruta-muraria", "Asplenium trichomanes",
  "Asplenium viride", "Aster bellidiastrum", "Astragalus glycyphyllos", "Athyrium filix-femina",
  "Atriplex patula", "Atropa bella-donna", "Avenella flexuosa", "Barbarea intermedia",
  "Barbarea vulgaris", "Bellis perennis", "Berberis vulgaris", "Berula erecta",
  "Betula pendula", "Betula pubescens", "Bidens tripartita", "Blechnum spicant",
  "Brachypodium pinnatum", "Brachypodium sylvaticum", "Briza media", "Bromus benekenii",
  "Bromus erectus", "Bromus ramosus", "Bromus sterilis", "Bromus tectorum",
  "Buphthalmum salicifolium", "Calamagrostis epigejos", "Calamagrostis varia", "Calluna vulgaris",
  "Caltha palustris", "Calystegia sepium", "Campanula cochleariifolia", "Campanula glomerata",
  "Campanula patula", "Campanula persicifolia", "Campanula rapunculoides", "Campanula rapunculus",
  "Campanula rotundifolia", "Campanula trachelium", "Capsella bursa-pastoris", "Capsella rubella",
  "Cardamine amara", "Cardamine bulbifera", "Cardamine flexuosa", "Cardamine hirsuta",
  "Cardamine impatiens", "Cardamine pentaphyllos", "Cardamine pratensis", "Carex acuta",
  "Carex acutiformis", "Carex alba", "Carex appropinquata", "Carex brizoides",
  "Carex caryophyllea", "Carex davalliana", "Carex digitata", "Carex distans",
  "Carex disticha", "Carex divulsa", "Carex echinata", "Carex elata",
  "Carex elongata", "Carex flacca", "Carex flava", "Carex hirta",
  "Carex hostiana", "Carex humilis", "Carex leersii", "Carex lepidocarpa",
  "Carex leporina", "Carex montana", "Carex nigra", "Carex ornithopoda",
  "Carex otrubae", "Carex pairae", "Carex pallescens", "Carex panicea",
  "Carex paniculata", "Carex pilosa", "Carex pilulifera", "Carex remota",
  "Carex riparia", "Carex rostrata", "Carex spicata", "Carex strigosa",
  "Carex sylvatica", "Carex tomentosa", "Carex umbrosa", "Carex vesicaria",
  "Carlina vulgaris", "Carpinus betulus", "Carum carvi", "Catapodium rigidum",
  "Centaurea jacea", "Centaurea montana", "Centaurea scabiosa", "Centaurium erythraea",
  "Cerastium brachypetalum", "Cerastium fontanum", "Cerastium glomeratum", "Cerastium semidecandrum",
  "Ceratophyllum demersum", "Chaenorrhinum minus", "Chaerophyllum aureum", "Chaerophyllum hirsutum",
  "Chelidonium majus", "Chenopodium album", "Chenopodium ficifolium", "Chenopodium polyspermum",
  "Chrysosplenium alternifolium", "Cichorium intybus", "Circaea lutetiana", "Cirsium arvense",
  "Cirsium oleraceum", "Cirsium palustre", "Cirsium vulgare", "Cladium mariscus",
  "Clematis vitalba", "Clinopodium vulgare", "Colchicum autumnale", "Convallaria majalis",
  "Convolvulus arvensis", "Corydalis cava", "Corylus avellana", "Cotoneaster tomentosus",
  "Crataegus laevigata", "Crataegus monogyna", "Crepis biennis", "Crepis capillaris",
  "Crepis foetida", "Crepis paludosa", "Crepis vesicaria", "Cruciata laevipes",
  "Cymbalaria muralis", "Cynodon dactylon", "Cynosurus cristatus", "Cystopteris fragilis",
  "Dactylis glomerata", "Danthonia decumbens", "Daphne mezereum", "Daucus carota",
  "Deschampsia cespitosa", "Dianthus armeria", "Digitaria sanguinalis", "Dipsacus fullonum",
  "Dipsacus laciniatus", "Dipsacus pilosus", "Dryopteris affinis", "Dryopteris carthusiana",
  "Dryopteris dilatata", "Dryopteris filix-mas", "Echinochloa crus-galli", "Echium vulgare",
  "Eleocharis austriaca", "Eleocharis palustris", "Elymus caninus", "Elymus repens",
  "Epilobium angustifolium", "Epilobium collinum", "Epilobium dodonaei", "Epilobium hirsutum",
  "Epilobium montanum", "Epilobium obscurum", "Epilobium palustre", "Epilobium parviflorum",
  "Epilobium roseum", "Epilobium tetragonum", "Equisetum arvense", "Equisetum fluviatile",
  "Equisetum hyemale", "Equisetum palustre", "Equisetum sylvaticum", "Equisetum telmateia",
  "Eragrostis minor", "Eragrostis pilosa", "Eranthis hyemalis", "Eriophorum angustifolium",
  "Eriophorum latifolium", "Erodium cicutarium", "Erophila praecox", "Erophila verna",
  "Erucastrum gallicum", "Erysimum cheiranthoides", "Euonymus europaeus", "Euonymus latifolius",
  "Eupatorium cannabinum", "Euphorbia amygdaloides", "Euphorbia cyparissias", "Euphorbia dulcis",
  "Euphorbia exigua", "Euphorbia helioscopia", "Euphorbia peplus", "Euphorbia platyphyllos",
  "Euphorbia stricta", "Euphorbia verrucosa", "Euphrasia rostkoviana", "Fagus sylvatica",
  "Fallopia convolvulus", "Festuca altissima", "Festuca arundinacea", "Festuca gigantea",
  "Festuca pratensis", "Festuca rubra", "Filipendula ulmaria", "Fragaria vesca",
  "Frangula alnus", "Fraxinus excelsior", "Fumaria officinalis", "Galeopsis angustifolia",
  "Galeopsis tetrahit", "Galium album", "Galium aparine", "Galium elongatum",
  "Galium odoratum", "Galium palustre", "Galium pumilum", "Galium rotundifolium",
  "Galium sylvaticum", "Galium uliginosum", "Galium verum", "Genista tinctoria",
  "Gentiana asclepiadea", "Geranium columbinum", "Geranium dissectum", "Geranium molle",
  "Geranium palustre", "Geranium pratense", "Geranium pusillum", "Geranium pyrenaicum",
  "Geranium robertianum", "Geranium rotundifolium", "Geranium sanguineum", "Geranium sylvaticum",
  "Geum rivale", "Geum urbanum", "Glechoma hederacea", "Glyceria fluitans",
  "Glyceria notata", "Gnaphalium uliginosum", "Groenlandia densa", "Gymnocarpium dryopteris",
  "Gymnocarpium robertianum", "Hedera helix", "Helianthemum nummularium", "Helictotrichon pubescens",
  "Helleborus foetidus", "Hepatica nobilis", "Heracleum sphondylium", "Herniaria glabra",
  "Hieracium lachenalii", "Hieracium lactucella", "Hieracium pilosella", "Hieracium piloselloides",
  "Hippocrepis comosa", "Hippuris vulgaris", "Holcus lanatus", "Holcus mollis",
  "Hordelymus europaeus", "Humulus lupulus", "Hypericum hirsutum", "Hypericum humifusum",
  "Hypericum maculatum", "Hypericum montanum", "Hypericum perforatum", "Hypericum tetrapterum",
  "Hypericum xdesetangsii", "Hypochaeris radicata", "Ilex aquifolium", "Impatiens noli-tangere",
  "Inula conyzae", "Inula salicina", "Iris pseudacorus", "Juglans regia",
  "Juncus alpinoarticulatus", "Juncus articulatus", "Juncus bufonius", "Juncus compressus",
  "Juncus conglomeratus", "Juncus effusus", "Juncus inflexus", "Juncus subnodulosus",
  "Juniperus communis", "Kickxia elatine", "Kickxia spuria", "Knautia arvensis",
  "Knautia dipsacifolia", "Lactuca serriola", "Lamium album", "Lamium galeobdolon",
  "Lamium maculatum", "Lamium purpureum", "Lapsana communis", "Lathraea squamaria",
  "Lathyrus linifolius", "Lathyrus pratensis", "Lathyrus sylvestris", "Lathyrus vernus",
  "Lemna minor", "Lemna trisulca", "Leontodon autumnalis", "Leontodon hispidus",
  "Leontodon saxatilis", "Lepidium campestre", "Leucanthemum vulgare", "Leucojum vernum",
  "Ligustrum vulgare", "Lilium martagon", "Linaria vulgaris", "Linum catharticum",
  "Lithospermum officinale", "Lolium perenne", "Lonicera alpigena", "Lonicera nigra",
  "Lonicera periclymenum", "Lonicera xylosteum", "Lotus corniculatus", "Lotus pedunculatus",
  "Luzula campestris", "Luzula luzuloides", "Luzula multiflora", "Luzula pilosa",
  "Luzula sylvatica", "Lycopodium annotinum", "Lycopus europaeus", "Lysimachia nemorum",
  "Lysimachia nummularia", "Lysimachia vulgaris", "Lythrum salicaria", "Maianthemum bifolium",
  "Malva alcea", "Malva moschata", "Malva neglecta", "Malva sylvestris",
  "Matricaria chamomilla", "Medicago lupulina", "Medicago xvaria", "Melampyrum pratense",
  "Melica nutans", "Melilotus albus", "Melilotus altissimus", "Melilotus officinalis",
  "Melissa officinalis", "Melittis melissophyllum", "Mentha aquatica", "Mentha arvensis",
  "Mentha longifolia", "Menyanthes trifoliata", "Mercurialis perennis", "Minuartia hybrida",
  "Moehringia trinervia", "Molinia arundinacea", "Molinia caerulea", "Mycelis muralis",
  "Myosotis arvensis", "Myosotis nemorosa", "Myosotis scorpioides", "Myosotis sylvatica",
  "Myosoton aquaticum", "Myriophyllum spicatum", "Myriophyllum verticillatum", "Najas marina",
  "Nasturtium officinale", "Nuphar lutea", "Nymphaea alba", "Nymphoides peltata",
  "Ononis repens", "Ononis spinosa", "Oreopteris limbosperma", "Origanum vulgare",
  "Ornithogalum umbellatum", "Orobanche minor", "Orthilia secunda", "Oxalis acetosella",
  "Oxalis corniculata", "Papaver dubium", "Papaver rhoeas", "Paris quadrifolia",
  "Parnassia palustris", "Pastinaca sativa", "Petasites albus", "Petasites hybridus",
  "Petrorhagia prolifera", "Petrorhagia saxifraga", "Peucedanum cervaria", "Peucedanum palustre",
  "Phalaris arundinacea", "Phegopteris connectilis", "Phleum pratense", "Phragmites australis",
  "Phyllitis scolopendrium", "Phyteuma orbiculare", "Phyteuma spicatum", "Picea abies",
  "Picris hieracioides", "Pimpinella major", "Pimpinella saxifraga", "Pinus sylvestris",
  "Plantago lanceolata", "Plantago major", "Plantago media", "Poa angustifolia",
  "Poa annua", "Poa compressa", "Poa nemoralis", "Poa palustris",
  "Poa pratensis", "Poa trivialis", "Polygala amarella", "Polygala chamaebuxus",
  "Polygala vulgaris", "Polygonatum multiflorum", "Polygonatum odoratum", "Polygonatum verticillatum",
  "Polygonum amphibium", "Polygonum aviculare", "Polygonum bistorta", "Polygonum hydropiper",
  "Polygonum lapathifolium", "Polygonum minus", "Polygonum mite", "Polygonum persicaria",
  "Polypodium vulgare", "Polystichum aculeatum", "Populus alba", "Populus nigra",
  "Populus tremula", "Portulaca oleracea", "Potamogeton berchtoldii", "Potamogeton crispus",
  "Potamogeton lucens", "Potamogeton natans", "Potamogeton pectinatus", "Potamogeton perfoliatus",
  "Potentilla anserina", "Potentilla erecta", "Potentilla recta", "Potentilla reptans",
  "Potentilla sterilis", "Potentilla verna", "Prenanthes purpurea", "Primula acaulis",
  "Primula elatior", "Primula veris", "Prunella grandiflora", "Prunella vulgaris",
  "Prunus avium", "Prunus padus", "Prunus spinosa", "Pteridium aquilinum",
  "Pulicaria dysenterica", "Pulmonaria obscura", "Pulmonaria officinalis", "Pyrus pyraster",
  "Quercus petraea", "Quercus robur", "Ranunculus aconitifolius", "Ranunculus acris",
  "Ranunculus bulbosus", "Ranunculus ficaria", "Ranunculus flammula", "Ranunculus lanuginosus",
  "Ranunculus repens", "Ranunculus trichophyllus", "Ranunculus tuberosus", "Raphanus raphanistrum",
  "Reseda lutea", "Rhamnus cathartica", "Rhinanthus alectorolophus", "Rhinanthus minor",
  "Rhynchospora alba", "Ribes uva-crispa", "Rorippa palustris", "Rorippa sylvestris",
  "Rosa arvensis", "Rosa canina", "Rosa corymbifera", "Rosa pendulina",
  "Rosa rubiginosa", "Rosa tomentosa", "Rubus caesius", "Rubus idaeus",
  "Rubus saxatilis", "Rumex acetosa", "Rumex acetosella", "Rumex conglomeratus",
  "Rumex crispus", "Rumex sanguineus", "Sagina apetala", "Sagina procumbens",
  "Salix alba", "Salix appendiculata", "Salix aurita", "Salix caprea",
  "Salix cinerea", "Salix elaeagnos", "Salix myrsinifolia", "Salix purpurea",
  "Salix triandra", "Salix viminalis", "Salix xfragilis", "Salvia glutinosa",
  "Salvia pratensis", "Sambucus ebulus", "Sambucus nigra", "Sambucus racemosa",
  "Sanguisorba minor", "Sanguisorba officinalis", "Sanicula europaea", "Saponaria officinalis",
  "Saxifraga tridactylites", "Scabiosa columbaria", "Schoenoplectus lacustris", "Schoenoplectus tabernaemontani",
  "Schoenus nigricans", "Scilla bifolia", "Scirpus sylvaticus", "Scrophularia nodosa",
  "Scrophularia umbrosa", "Scutellaria galericulata", "Securigera varia", "Sedum acre",
  "Sedum album", "Sedum hispanicum", "Sedum rupestre", "Sedum sexangulare",
  "Senecio aquaticus", "Senecio erucifolius", "Senecio jacobaea", "Senecio ovatus",
  "Senecio paludosus", "Senecio viscosus", "Senecio vulgaris", "Sesleria caerulea",
  "Setaria pumila", "Setaria verticillata", "Setaria viridis", "Sherardia arvensis",
  "Silene dioica", "Silene flos-cuculi", "Silene nutans", "Silene pratensis",
  "Silene vulgaris", "Sinapis alba", "Sinapis arvensis", "Sisymbrium officinale",
  "Solanum dulcamara", "Solidago virgaurea", "Sonchus arvensis", "Sonchus asper",
  "Sonchus oleraceus", "Sorbus aria", "Sorbus aucuparia", "Sorbus mougeotii",
  "Sorbus torminalis", "Sparganium erectum", "Spirodela polyrhiza", "Stachys alpina",
  "Stachys officinalis", "Stachys palustris", "Stachys recta", "Stachys sylvatica",
  "Stellaria alsine", "Stellaria graminea", "Stellaria media", "Stellaria nemorum",
  "Succisa pratensis", "Symphytum officinale", "Tamus communis", "Tanacetum corymbosum",
  "Tanacetum vulgare", "Taxus baccata", "Teucrium chamaedrys", "Teucrium scorodonia",
  "Thalictrum aquilegiifolium", "Thlaspi arvense", "Thlaspi perfoliatum", "Thymus pulegioides",
  "Tilia cordata", "Tilia platyphyllos", "Tofieldia calyculata", "Torilis japonica",
  "Tragopogon pratensis", "Trifolium campestre", "Trifolium dubium", "Trifolium fragiferum",
  "Trifolium medium", "Trifolium pratense", "Trifolium repens", "Tripleurospermum inodorum",
  "Trisetum flavescens", "Tussilago farfara", "Typha angustifolia", "Typha latifolia",
  "Ulmus glabra", "Ulmus minor", "Urtica dioica", "Utricularia australis",
  "Vaccinium myrtillus", "Valeriana dioica", "Valeriana officinalis", "Valerianella carinata",
  "Valerianella locusta", "Verbascum blattaria", "Verbascum densiflorum", "Verbascum lychnitis",
  "Verbascum nigrum", "Verbascum thapsus", "Verbena officinalis", "Veronica agrestis",
  "Veronica anagallis-aquatica", "Veronica arvensis", "Veronica beccabunga", "Veronica chamaedrys",
  "Veronica hederifolia", "Veronica montana", "Veronica officinalis", "Veronica polita",
  "Veronica serpyllifolia", "Veronica urticifolia", "Viburnum lantana", "Viburnum opulus",
  "Vicia cracca", "Vicia dumetorum", "Vicia hirsuta", "Vicia sativa",
  "Vicia sepium", "Vicia tetrasperma", "Vinca minor", "Vincetoxicum hirundinaria",
  "Viola alba", "Viola arvensis", "Viola hirta", "Viola mirabilis",
  "Viola odorata", "Viola reichenbachiana", "Viola riviniana", "Viscum album",
  "Vulpia myuros"
]);
const GREENLIST_NATIVE_EQUIVALENTS = new Set([
  "Pinus sylvatica", "Populus x canescens", "Salix fragilis", "Tilia europaea",
  "Tilia x europaea"
]);
const UNCLEAR_SPECIES = new Set([
  "0_UNBESTIMMT", "Acer x", "Aesculus hybrida", "Eco Arbore",
  "Magnolia", "Malus Hybride", "Populus x", "Prunus Frühe Zierkirsche",
  "Ulmus", "Ulmus New Horizon", "Unbekannt"
]);

function speciesCore(name){
  ...
  if(!s || s.startsWith("0_") || lower.includes("unbekannt") || lower.includes("unbestimmt") || lower.includes("hybride") || UNCLEAR_SPECIES.has(s)) return "";
  const t=s.split(" ");
  if(t.length<2) return "";
  const genus=t[0];
  if(t[1].toLowerCase()==="x"){
    if(t.length>=3) return `${genus} x ${t[2]}`;
    return "";
  }
  let epithet=t[1];
  // kleine Kataster-Schreibvarianten/Kultivarzusätze
  if(epithet.toLowerCase()==="excelsiors") epithet="excelsior";
  return `${genus} ${epithet}`;
}

function nativeInfo(sp){
  const raw=String(sp.name||"").trim();
  const core=speciesCore(raw);
  if(!raw || !core || UNCLEAR_SPECIES.has(raw)) return {status:"unclear",label:"Unklar",color:TEXT_MUTE};
  if(GREENLIST_OSTMITTELLAND_CORES.has(core) || GREENLIST_NATIVE_EQUIVALENTS.has(core) || GREENLIST_NATIVE_EQUIVALENTS.has(raw)){
    return {status:"native",label:"Einheimisch",color:GREEN};
  }
  return {status:"non_native",label:"Nicht einheimisch",color:BRICK};
}
...
const DEFAULTS={
  ...
  plantGoalCount:18000, plantGoalYearOff:24, establishmentRate:0.85, plannedPlantingAnnual:500,
};
const PRESETS={
...
function speciesClimateFit(sp,scenario){
  return (sp.climateFitByScenario?.[scenario] ?? sp.climateFit ?? 0.55);
}
function strategyWeight(sp,strategy,scenario){
  const fit=Math.max(0.2,speciesClimateFit(sp,scenario));
  if(strategy==="same_mix") return 1;
  if(strategy==="long_life") return Math.pow(sp.life/LIFE_REF,1.4);
  if(strategy==="climate_fit") return Math.pow(fit,2.4);
  // balanced: Klima-Fit, Lebensdauer und leichte Diversitätsförderung kombiniert
  return Math.pow(fit,1.5)*Math.pow(sp.life/LIFE_REF,0.8)*Math.pow(1/(sp.count+250),0.12);
}
function simulateSpecies(p,det){
  ...
  for(let t=1;t<=YEARS;t++){
    ...
    const lossWeights=counts.map((c,i)=>{const fit=speciesClimateFit(SPECIES_BASE[i],p.scenario);return c*Math.max(0.2,SPECIES_BASE[i].risk)*(1+(1-fit)*p.climateTrendEnd*(t/YEARS));});
    ...
    const plantWeights=SPECIES_BASE.map(sp=>strategyWeight(sp,p.strategy,p.scenario));
  ...
  const rows=SPECIES_BASE.map((sp,i)=>{
    const ni=nativeInfo(sp);
    return {
      ...sp,
      nativeStatus:ni.status,
      nativeLabel:ni.label,
      nativeColor:ni.color,
      start:history[0][i],
      mid:history[Math.min(YEARS,25)][i],
      end:history[YEARS][i],
      selected:history[p.viewYearOff]?.[i]??history[YEARS][i],
      climateFitSelected:speciesClimateFit(sp,p.scenario),
    };
  ...
  const climateFitShare=rows.filter(r=>(r.climateFitSelected??r.climateFit)>=0.70).reduce((a,b)=>a+b.selected,0)/totalNow;
  ...
  const chart=rows.slice(0,10).map(r=>({
    ...
    fit:Math.round((r.climateFitSelected??r.climateFit)*100),
    avgAge:r.avgAge,
    life:r.life,
    fallen:r.fallen,
    native:r.nativeLabel,
  }));
    ...
    {labels.map((lab,i)=>{const o=classOld[i],n=classNew[i],tot=o+n;
      return(<div key={i} className="flex items-center" style={{gap:8}}>
        ...
        <div style={{flex:1,height:15,background:"#f2f1ec",borderRadius:3,overflow:"hidden",display:"flex"}}>
          ...
          <div style={{width:`${n/maxV*100}%`,background:GREEN,opacity:.8,transition:"width .25s"}}/></div>
...
function SpeciesPanel({species,year}){
  ...
  const nativeSummary=useMemo(()=>{
    const total=rows.reduce((a,b)=>a+b.selected,0)||1;
    const native=rows.filter(r=>r.nativeStatus==="native").reduce((a,b)=>a+b.selected,0)/total;
    const nonNative=rows.filter(r=>r.nativeStatus==="non_native").reduce((a,b)=>a+b.selected,0)/total;
    const unclear=rows.filter(r=>r.nativeStatus==="unclear").reduce((a,b)=>a+b.selected,0)/total;
    return {native,nonNative,unclear};
  },[rows]);

  const displayRows=useMemo(()=>{
    let arr=rows.filter(r=>nativeFilter==="all" || r.nativeStatus===nativeFilter);
    if(speciesMode==="top_start") arr.sort((a,b)=>b.start-a.start);
      ...
      if(arr.length===0) arr=rows.filter(r=>nativeFilter==="all" || r.nativeStatus===nativeFilter).sort((a,b)=>b.selected-a.selected).slice(0,speciesLimit);
    }else arr.sort((a,b)=>b.selected-a.selected);
    return arr.slice(0,speciesLimit);
  },[rows,speciesMode,speciesLimit,manual,nativeFilter]);
  ...
  const selectList=useMemo(()=>rows.filter(r=>nativeFilter==="all" || r.nativeStatus===nativeFilter).sort((a,b)=>b.absShareChange-a.absShareChange).slice(0,40),[rows,nativeFilter]);
  ...
  return(<>
    <div style={{background:PANEL,border:`1px solid ${LINE_GRID}`,borderRadius:16,padding:"18px 14px 8px"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"baseline",padding:"0 8px 8px",gap:10,flexWrap:"wrap"}}>
        <div>
          ...
          <div style={{fontSize:11,color:TEXT_MUTE,fontFamily:"var(--mono)",marginTop:2}}>Ansicht: {modeLabel} · Herkunft: {nativeFilter==="all"?"alle":nativeFilter==="native"?"einheimisch":nativeFilter==="non_native"?"nicht einheimisch":"unklar"} · {displayRows.length} Arten</div>
        </div>
        <div style={{fontSize:11,color:TEXT_MUTE,fontFamily:"var(--mono)"}}>deterministische Artenschicht · CityGOER/TreeGOER/CityTrees-II ergänzt</div>
      </div>
      ...
      <div style={{display:"flex",gap:10,flexWrap:"wrap",padding:"4px 8px 12px",alignItems:"center"}}>
        ...
        <div style={{height:22,width:1,background:LINE_GRID,margin:"0 2px"}}/>
        {[["all","Alle"],["native","Einheimisch"],["non_native","Nicht einheimisch"],["unclear","Unklar"]].map(([id,lab])=>{const a=nativeFilter===id;return(<button key={id} onClick={()=>setNativeFilter(id)} style={{fontSize:12,padding:"6px 10px",borderRadius:8,cursor:"pointer",border:`1px solid ${a?GREEN:LINE_GRID}`,background:a?"rgba(47,125,79,0.08)":"transparent",color:a?GREEN:SAGE,fontFamily:"var(--mono)"}}>{lab}</button>);})}
      ...
      {speciesMode==="manual"&&<div style={{margin:"0 8px 12px",padding:"10px 12px",border:`1px solid ${LINE_GRID}`,borderRadius:12,background:"#faf9f5"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(210px,1fr))",gap:6}}>
          {selectList.map(r=><label key={r.name} style={{fontSize:11.5,color:PAPER,display:"flex",alignItems:"center",gap:6,cursor:"pointer"}}>
            ...
            <span>{r.label}</span>
            <span style={{fontSize:10.5,color:r.nativeColor,border:`1px solid ${r.nativeColor}55`,borderRadius:99,padding:"1px 5px"}}>{r.nativeLabel}</span>
    ...
    <div className="flex" style={{gap:12,marginTop:14,flexWrap:"wrap"}}>
      {[["Top-5-Anteil",Math.round(species.top5Share*100)+" %",PAPER],["Klima-Fit ≥70 %",Math.round(species.climateFitShare*100)+" %",GREEN],["Einheimisch",Math.round(nativeSummary.native*100)+" %",GREEN],["Nicht einheimisch",Math.round(nativeSummary.nonNative*100)+" %",BRICK],["Diversität",species.shannon.toFixed(2),MOSS]].map(([l,val,c])=>(
    ...
    <div style={{marginTop:14,background:CARD,border:`1px solid ${LINE_GRID}`,borderRadius:12,padding:"14px 18px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1.15fr .42fr .42fr .48fr .48fr .36fr .36fr .55fr .55fr",gap:8,fontSize:11,color:TEXT_MUTE,fontFamily:"var(--mono)",borderBottom:`1px solid ${LINE_GRID}`,paddingBottom:6,marginBottom:6}}>
        <div>Artengruppe</div><div>2026</div><div>{year}</div><div>Δ Anzahl</div><div>Δ Anteil</div><div>Fit</div><div>Alter</div><div>Herkunft</div><div>Quelle</div>
      </div>
      {displayRows.map(r=>(<div key={r.name} style={{display:"grid",gridTemplateColumns:"1.15fr .42fr .42fr .48fr .48fr .36fr .36fr .55fr .55fr",gap:8,fontSize:12,padding:"5px 0",borderBottom:`1px solid ${LINE_GRID}55`}}>
        ...
        <div style={{fontFamily:"var(--mono)",color:(r.climateFitSelected??r.climateFit)>=0.7?GREEN:((r.climateFitSelected??r.climateFit)<0.45?BRICK:SAGE)}}>{Math.round((r.climateFitSelected??r.climateFit)*100)} %</div>
        <div style={{fontFamily:"var(--mono)",color:SAGE}}>{r.avgAge} J</div>
        <div style={{fontFamily:"var(--mono)",color:r.nativeColor}}>{r.nativeLabel}</div>
        <div style={{fontFamily:"var(--mono)",color:SAGE}}>{r.climateSource}</div>
      </div>))}
      <div style={{fontSize:11,color:TEXT_MUTE,lineHeight:1.5,marginTop:10}}>{SPECIES_NOTE} Die Ansicht kann Top-Bestand, stärkste Zunahme, stärkste Abnahme, grösste Veränderung oder eine eigene Auswahl zeigen. Für vollständige Modelltreue sollten langfristig species_summary.csv/species_milestones.csv aus dem Python-Lauf direkt eingelesen werden.</div>
    </div>
  </>);
}


function avgDeathsUntil(det,horizon){
  const h=Math.max(1,Math.min(YEARS,Math.round(horizon)));
  let s=0; for(let t=1;t<=h;t++) s+=(det.deaths[t]||0);
  return s/h;
}
function modelPlantingUntil(p,det,horizon){
  const h=Math.max(1,Math.min(YEARS,Math.round(horizon)));
  let repl=0,extra=0;
  for(let t=1;t<=h;t++){
    if(t-p.replacementDelay>=1) repl += p.replacementRate*(det.deaths[t-p.replacementDelay]||0);
    if(t>=p.newStart && t<=p.newEnd) extra += p.annualNewTrees;
  }
  return {replacementAvg:repl/h,extraAvg:extra/h,totalAvg:(repl+extra)/h};
}
function calcPlantingNeed(p,det,horizon){
  const h=Math.max(1,Math.min(YEARS,Math.round(horizon)));
  const est=Math.max(0.5,Math.min(1,Number(p.establishmentRate)||0.85));
  const current=det.total?.[0] ?? p.N0;
  const goalOff=Math.max(1,Math.min(YEARS,Math.round(p.plantGoalYearOff||h)));
  const goal=Number(p.plantGoalCount)||current;
  const target=current+(goal-current)*Math.min(h/goalOff,1);
  const avgDeaths=avgDeathsUntil(det,h);
  const maintain=avgDeaths/est;
  const build=Math.max(0,(target-current)/h)/est;
  const total=maintain+build;
  const planned=Number(p.plannedPlantingAnnual)||0;
  const model=modelPlantingUntil(p,det,h);
  const establishedPlanned=planned*est;
  const netEstablishedPerYear=establishedPlanned-avgDeaths;
  const gap=planned-total;
  let status={label:"Pflanzleistung reicht",color:GREEN,note:"Erhalt und Zielbestand sind mit der geplanten Pflanzleistung plausibel erreichbar."};
  if(planned<maintain) status={label:"Zu wenig für Erhalt",color:BRICK,note:"Die geplante Pflanzleistung reicht nicht, um die erwarteten Ausfälle langfristig zu kompensieren."};
  else if(planned<total) status={label:"Erhalt ja, Ausbau nein",color:AMBER,note:"Der heutige Bestand kann ungefähr gehalten werden, der Zielbestand wird aber voraussichtlich nicht erreicht."};
  return {horizon:h,year:yearAt(h),current,target,goal,est,avgDeaths,maintain,build,total,planned,model,establishedPlanned,netEstablishedPerYear,gap,status};
}

function PlantingNeedPanel({p,set,det,series}){
  const main=calcPlantingNeed(p,det,p.plantGoalYearOff);
  const horizons=[4,24,49,74,100];
  const chart=horizons.map(h=>{const n=calcPlantingNeed(p,det,h);return {jahr:String(n.year),erhalt:Math.round(n.maintain),aufbau:Math.round(n.build),gesamt:Math.round(n.total),geplant:Math.round(p.plannedPlantingAnnual),modell:Math.round(n.model.totalAvg)};});
  const finalPt=series[Math.min(YEARS,main.horizon)];
  const forecastGap=finalPt ? finalPt.p50-main.target : 0;
  const cards=[
    ["Erhaltungsbedarf",fmt(main.maintain)+" / Jahr",PAPER,"Pflanzungen, die nötig sind, um erwartete Ausfälle zu ersetzen"],
    ["Aufbaubedarf",fmt(main.build)+" / Jahr",MOSS,"zusätzliche Pflanzungen für den Zielbestand"],
    ["Gesamtbedarf",fmt(main.total)+" / Jahr",main.status.color,"Erhaltungsbedarf + Aufbaubedarf"],
    ["Pflanzlücke",(main.gap>=0?"+":"")+fmt(main.gap)+" / Jahr",main.gap>=0?GREEN:BRICK,"geplante Pflanzleistung minus Gesamtbedarf"],
    ["Modellpflanzungen",fmt(main.model.totalAvg)+" / Jahr",SAGE,"Durchschnitt aus Ersatzpflanzungen und Zusatzpflanzungen der aktuellen Regler"],
  ];
  return(<>
    <div style={{background:CARD,border:`1px solid ${main.status.color}66`,borderRadius:16,padding:"18px 18px 16px",marginBottom:14}}>
      <div style={{display:"flex",alignItems:"center",gap:12,flexWrap:"wrap",marginBottom:10}}>
        <div style={{width:14,height:14,borderRadius:99,background:main.status.color,boxShadow:`0 0 14px ${main.status.color}`}}/>
        <div>
          <div style={{fontFamily:"var(--display)",fontSize:25,fontWeight:750,color:main.status.color,lineHeight:1.1}}>{main.status.label}</div>
          <div style={{fontSize:12,color:TEXT_MUTE,marginTop:3,lineHeight:1.45}}>{main.status.note}</div>
        </div>
      </div>
      <div style={{fontSize:14,color:PAPER,lineHeight:1.55,maxWidth:900}}>
        Für einen Zielbestand von <b>{fmt(main.target)}</b> Bäumen bis <b>{main.year}</b> braucht es unter den aktuellen Annahmen rund <b style={{color:main.status.color}}>{fmt(main.total)} Pflanzungen pro Jahr</b>. Davon dienen etwa <b>{fmt(main.maintain)}</b> dem Erhalt und <b>{fmt(main.build)}</b> dem Aufbau. Bei <b>{Math.round(main.est*100)} %</b> Anwuchsquote ergeben {fmt(main.planned)} geplante Pflanzungen/Jahr netto rund <b>{fmt(main.establishedPlanned)}</b> etablierte Bäume/Jahr.
      </div>
    </div>

    <div style={{background:PANEL,border:`1px solid ${LINE_GRID}`,borderRadius:16,padding:"16px 14px 8px",marginBottom:14}}>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(210px,1fr))",gap:14,padding:"2px 4px 8px"}}>
        <div>
          <Segmented label="Zieljahr" value={p.plantGoalYearOff} options={[{value:4,label:"2030"},{value:24,label:"2050"},{value:49,label:"2075"},{value:74,label:"2100"},{value:100,label:"2126"}]} onChange={v=>set("plantGoalYearOff")(parseInt(v,10))}/>
        </div>
        <div>
          <Slider label="Zielbestand im Zieljahr" value={p.plantGoalCount} min={14000} max={26000} step={250} onChange={set("plantGoalCount")} display={fmt(p.plantGoalCount)} hint="Zielgrösse für die Pflanzbedarfsrechnung"/>
        </div>
        <div>
          <Slider label="Anwuchsquote / Etablierungsrate" value={p.establishmentRate} min={0.6} max={1} step={0.05} onChange={set("establishmentRate")} display={Math.round(p.establishmentRate*100)+" %"} hint="Anteil der Pflanzungen, der langfristig als Baum erhalten bleibt"/>
        </div>
        <div>
          <Slider label="Geplante Gesamtpflanzungen / Jahr" value={p.plannedPlantingAnnual} min={0} max={1200} step={25} onChange={set("plannedPlantingAnnual")} display={fmt(p.plannedPlantingAnnual)} hint="Vergleichswert für Budget/Planung; ändert die Modellkurve nicht direkt"/>
        </div>
      </div>
    </div>
    ...
    <div className="flex" style={{gap:12,marginBottom:14,flexWrap:"wrap"}}>
      {cards.map(([l,val,c,h])=>(
        <div key={l} style={{background:CARD,border:`1px solid ${LINE_GRID}`,borderRadius:12,padding:"12px 15px",flex:"1 1 0",minWidth:145}}>
          <div style={{fontSize:11,color:TEXT_MUTE}}>{l}</div>
          <div style={{fontFamily:"var(--display)",fontSize:24,fontWeight:600,color:c,fontVariantNumeric:"tabular-nums"}}>{val}</div>
          <div style={{fontSize:10.5,color:TEXT_MUTE,lineHeight:1.3,marginTop:4}}>{h}</div>
        </div>
      ))}
    </div>

    <div style={{background:PANEL,border:`1px solid ${LINE_GRID}`,borderRadius:16,padding:"16px 14px 8px",marginBottom:14}}>
      <div style={{fontSize:13,color:SAGE,fontWeight:600,padding:"0 8px 8px"}}>Benötigte Pflanzungen pro Jahr je Zielhorizont</div>
      <ResponsiveContainer width="100%" height={300}>
        <ComposedChart data={chart} margin={{top:10,right:20,bottom:8,left:12}}>
          <CartesianGrid stroke={LINE_GRID} strokeDasharray="2 4" vertical={false}/>
          <XAxis dataKey="jahr" tick={{fill:TEXT_MUTE,fontSize:11,fontFamily:"var(--mono)"}} stroke={LINE_GRID}/>
          <YAxis tick={{fill:TEXT_MUTE,fontSize:11,fontFamily:"var(--mono)"}} stroke={LINE_GRID} width={48}/>
          <Tooltip contentStyle={{background:"#fff",border:`1px solid ${LINE_GRID}`,borderRadius:9,fontFamily:"var(--mono)",fontSize:12}} formatter={(value,name)=>[fmt(value),name]}/>
          <Bar dataKey="erhalt" name="Erhaltungsbedarf" stackId="bedarf" fill={BARK} radius={[0,0,4,4]} isAnimationActive={false}/>
          <Bar dataKey="aufbau" name="Aufbaubedarf" stackId="bedarf" fill={MOSS} radius={[4,4,0,0]} isAnimationActive={false}/>
          <Line type="monotone" dataKey="geplant" name="geplant/Jahr" stroke={GREEN} strokeWidth={2.2} dot={false} isAnimationActive={false}/>
          <Line type="monotone" dataKey="modell" name="aktuelles Modell/Jahr" stroke={AMBER} strokeWidth={1.8} strokeDasharray="5 4" dot={false} isAnimationActive={false}/>
        </ComposedChart>
      </ResponsiveContainer>
      <div style={{fontSize:11,color:TEXT_MUTE,lineHeight:1.5,padding:"2px 8px 8px"}}>Grauer Balken = Ersatz für erwartete Ausfälle. Roter Balken = zusätzlicher Aufbau bis zum Zielbestand. Grüne Linie = frei eingestellte geplante Gesamtpflanzungen/Jahr. Gelbe Linie = durchschnittliche Pflanzungen, die aus den aktuellen Modellreglern entstehen.</div>
    </div>

    <div style={{background:CARD,border:`1px solid ${LINE_GRID}`,borderRadius:12,padding:"14px 18px"}}>
      <div style={{fontSize:13,color:SAGE,fontWeight:600,marginBottom:8}}>Lesart für Nicht-Fachpersonen</div>
      <div style={{fontSize:13,color:PAPER,lineHeight:1.55}}>
        Der Bestand bleibt nur stabil, wenn die jährlich ausfallenden Bäume nicht nur ersetzt, sondern erfolgreich etabliert werden. Bei {Math.round(main.est*100)} % Anwuchsquote müssen für 100 langfristig erhaltene Bäume rund {fmt(100/main.est)} Bäume gepflanzt werden. Für das Zieljahr {main.year} liegt die aktuelle Pflanzlücke bei <b style={{color:main.gap>=0?GREEN:BRICK}}>{main.gap>=0?"+":""}{fmt(main.gap)} Bäumen pro Jahr</b>. Die Bestandskurve im Modell liegt im Median im Zieljahr um <b style={{color:forecastGap>=0?GREEN:BRICK}}>{forecastGap>=0?"+":""}{fmt(forecastGap)}</b> Bäume gegenüber dem eingestellten Zielwert.
      </div>
    </div>
  </>);
}
...
export default function App(){
  ...
  const yMax=useMemo(()=>Math.max(p.targetCount,p.plantGoalCount,...series.map(d=>d.p95))*1.06,[series,p.targetCount,p.plantGoalCount]);
  ...
  function exportScenarioJSON(){
    const data = {
      ...
      currentVerdict: v,
      plantingNeed: calcPlantingNeed(p, det, p.plantGoalYearOff),
  ...
  return(<div ref={exportRef} style={{"--display":"'Inter',system-ui,sans-serif","--mono":"'JetBrains Mono',ui-monospace,monospace",
    ...
    <div style={{maxWidth:1240,margin:"0 auto"}}>
      <div style={{marginBottom:18}}>
        <div style={{fontSize:11,letterSpacing:2.5,textTransform:"uppercase",color:GREEN,fontWeight:700,marginBottom:8}}>Stadtgrün Winterthur · Baumversorgung</div>
        <h1 style={{fontFamily:"var(--display)",fontSize:"clamp(28px,4.4vw,52px)",fontWeight:800,lineHeight:1.0,margin:"0 0 8px",letterSpacing:-1.2}}>
          {view==="stock"?"Wie entwickelt sich der Baumbestand?":view==="demography"?"Wie verschiebt sich die Altersstruktur?":view==="species"?"Wie verändert sich die Baumartenzusammensetzung?":"Wie viele Bäume müssen gepflanzt werden?"}</h1>
        <div style={{width:48,height:3,background:GREEN,marginBottom:10}}/>
        <p style={{color:TEXT_MUTE,maxWidth:680,fontSize:14,lineHeight:1.5}}>
          {view==="stock"
            ...
            :view==="demography"
              ...
              :view==="species"
                ?"Katasterbasierte Baumarten-/Artengruppen-Ansicht mit aktuellen Anteilen, mittlerem Alter, historischen Fällungen und Lebensdauer-Bandbreiten."
                :"Pflanzbedarf als einfache Erhaltungs- und Aufbau-Rechnung: erwartete Ausfälle, Anwuchsquote, Zielbestand und Pflanzlücke."}</p></div>

      <div className="flex" style={{gap:8,marginBottom:18,alignItems:"center",flexWrap:"wrap"}}>
        {[["stock","Bestand"],["demography","Demografie"],["species","Baumarten"],["planting","Pflanzbedarf"]].map(([id,lab])=>(
      ...
      <div className="dash-grid" style={{display:"grid",gridTemplateColumns:"1fr",gap:18}}>
        <div>
          ...
          {view==="demography"&&(<>
            ...
            <div style={{background:PANEL,border:`1px solid ${LINE_GRID}`,borderRadius:16,padding:"18px 20px"}}>
              <div className="flex items-baseline" style={{justifyContent:"space-between",marginBottom:14,flexWrap:"wrap",gap:10}}>
                <div><div style={{fontSize:13,color:SAGE,fontWeight:600}}>Altersstruktur</div>
                  <div style={{fontSize:11,color:TEXT_MUTE,fontFamily:"var(--mono)",marginTop:2}}><span style={{color:BARK}}>■</span> Bestand 2026 · <span style={{color:GREEN}}>■</span> seit 2026 gepflanzt</div></div>
            ...
            <div className="flex" style={{gap:12,marginTop:14,flexWrap:"wrap"}}>
              {[["Gesamtbestand",fmt(det.total[yOff]),PAPER],["Medianalter",det.medAge[yOff]+" J",MOSS],
                ...
                ["seit 2026 gepflanzt",Math.round(renew*100)+" %",GREEN]].map(([l,val,c])=>(
          ...
          {view==="planting"&&(<PlantingNeedPanel p={p} set={set} det={det} series={series}/>) }
        </div>
        ...
        <div style={{background:PANEL,border:`1px solid ${LINE_GRID}`,borderRadius:16,padding:"20px 20px 8px"}}>
          ...
          <Section title="Ausfall & Klima">
            <div style={{fontSize:11.5,color:TEXT_MUTE,marginBottom:12,lineHeight:1.5}}>Basis-Ausfall = kalibrierte Alters-Hazard (fix). Klima = TreeGOER-Exceedance gegen Winterthurs Zukunfts-bio05. Zusatztrend = Rest-Stress, der über die Zeit linear zunimmt.</div>
            ...
            <Slider label="Zusatztrend Ausfallrisiko bis 2126" value={p.climateTrendEnd} min={0} max={1} step={0.05} onChange={set("climateTrendEnd")} display={"+"+(p.climateTrendEnd*100).toFixed(0)+" %"} hint="zusätzlicher linearer Ramp auf das Ausfallrisiko; ergänzt SSP/TreeGOER um nicht explizit modellierte Belastungen"/>
      ...
      <p style={{color:TEXT_MUTE,fontSize:12,lineHeight:1.6,marginTop:22,maxWidth:920}}>
        ...
        Unter SSP126 ist climate_mult ≈ 1.0; der zusätzliche Langzeit-Stress kommt dann vor allem aus dem Regler „Zusatztrend Ausfallrisiko“. Neue Bäume starten mit Alter {p.initAge}, Ersatz = round(Ausfälle·Rate) nach Verzögerung.

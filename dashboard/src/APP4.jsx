...
const SPECIES_DATASET = {
  ...
  source: "Baumkataster 2026-04-13 + species_life_ranges.csv + CityTrees-II + TreeGOER + CitiesGOER",
};

const SPECIES_NOTE="Katasterbasierte Artansicht mit Klimaergänzung: aktuelle Artanteile, historische Fällungen und mittleres Alter stammen aus dem Baumkataster 2026-04-13. Lebensdauerwerte stammen aus species_life_ranges.csv. Der Klima-Fit kombiniert, wo verfügbar, CityTrees-II (Urban-/Trockenheits-/Hitze-Eignung), TreeGOER (bio05-Wärmegrenze der Art) und CitiesGOER-Zukunftsklima für Winterthur. Abdeckung: TreeGOER 44.9 % der aktiven Bäume, CityTrees-II 68.3 %. Arten ohne Treffer verwenden weiterhin einen Proxywert und sind entsprechend als Proxy gekennzeichnet. Die Herkunftsklassierung Einheimisch/Nicht einheimisch ist eine pragmatische Dashboard-Klassierung nach wissenschaftlichem Namen und sollte für eine Fachfassung nochmals mit einer offiziellen Artenliste abgeglichen werden.";

/* Herkunft / Einheimischkeit: pragmatische Klassierung für die Dashboard-Kommunikation.
   Grundlage ist der wissenschaftliche Name im Kataster. Kultivare/Hybride werden der
   zugrundeliegenden Art zugeordnet, wo eindeutig; unsichere Sammelnamen bleiben "Unklar".
   Für eine finale Fachfassung sollte diese Liste mit einer offiziellen Stadt-/Kanton-Liste abgeglichen werden. */
const NATIVE_SPECIES = new Set([
  "Tilia europaea","Tilia x europaea","Acer campestre","Quercus robur","Carpinus betulus","Acer platanoides","Betula pendula","Fagus sylvatica",
  "Pinus sylvatica","Acer pseudoplatanus","Tilia platyphyllos","Tilia cordata","Prunus avium","Taxus baccata","Fraxinus excelsior",
  "Alnus glutinosa","Populus nigra","Salix alba","Prunus padus","Sorbus aria","Alnus incana","Larix decidua","Populus tremula",
  "Sorbus aucuparia","Cornus mas","Quercus petraea","Crataegus monogyna","Salix caprea","Salix fragilis","Sorbus domestica",
  "Ilex aquifolium","Acer monspessulanum","Ulmus glabra","Acer opalus","Populus alba","Quercus pubescens","Crataegus laevigata",
  "Ulmus laevis","Populus x canescens","Buxus sempervirens","Laburnum vulgare","Prunus insititia","Prunus mahaleb","Euonymus europaeus",
  "Pinus mugo","Rhamnus cathartica","Salix cinerea","Sambucus nigra","cornus sanguinea","Cornus sanguinea","Sorbus torminalis",
  "Castanea sativa","Ostrya carpinifolia","Fraxinus angustifolia"
]);
const NON_NATIVE_SPECIES = new Set([
  "Platanus x acerifolia","Aesculus hippocastanum","Prunus serrulata","Quercus cerris","Robinia pseudoacacia","Juglans regia","Pinus nigra",
  "Gleditsia triacanthos","Fraxinus ornus","Corylus colurna","Aesculus x carnea","Prunus subhirtella","Alnus x spaethii","Sophora japonica",
  "Parrotia persica","Cercidiphyllum japonicum","Liquidambar styraciflua","Liriodendron tulipifera","Celtis australis","Amelanchier lamarckii",
  "Quercus rubra","Acer saccharinum","Prunus sargentii","Tilia tomentosa","Koelreuteria paniculata","Acer palmatum","Amelanchier arborea",
  "Sorbus intermedia","Acer cappadocicum","Pyrus calleryana","Betula utilis","Celtis occidentalis","Chamaecyparis lawsoniana","Cladrastis kentukea",
  "Sequoiadendron giganteum","Catalpa bignonioides","Juglans nigra","Acer negundo","Alnus cordata","Gingko biloba","Morus alba",
  "Abies nordmanniana","Carya illinoinensis","Larix kaempferi","Magnolia kobus","Picea omorika","Magnolia x soulangeana","Pterocarya fraxinifolia",
  "Quercus palustris","Aesculus flava","Fraxinus pennsylvanica","Quercus ilex","Thuja plicata","Tilia americana","Ailanthus altissima",
  "Amelanchier canadensis","Cercis siliquastrum","Davidia involucrata","Gymnocladus dioicus","Toona sinensis","Acer ginnala","Ulmus hollandica",
  "Acer rubrum","Acer freemanii","Cornus florida","Quercus frainetto","Acer griseum","Betula nigra","Betula papyrifera","Cedrus atlantica",
  "Phellodendron amurense","Acer saccharum","Betula albosinensis","Catalpa speciosa","Magnolia grandiflora","Metasequoia glyptostroboides",
  "Picea orientalis","Pseudotsuga menziesii","Sorbus americana","Thuja occidentalis","Acer tataricum","Chamaecyparis pisifera","Cupressus arizonica",
  "Elaeagnus angustifolia","Fraxinus americana","Juglans mandshurica","Morus nigra","Nyssa sylvatica","Paulownia tomentosa","Picea pungens",
  "Prunus serotina","Quercus texana","Abies cephalonica","Abies concolor","Abies pinsapo","Acer carpinifolium","Acer velutinum",
  "Albizia julibrissin","Calocedrus decurrens","Cedrus libani","Chamaecyparis nootkatensis","Chamaecyparis obtusa","Chionanthus retusus",
  "Crataegus coccinoides","Crataegus crus-galli","Eucommia ulmoides","Larix x eurolepis","Nothofagus antarctica","Pinus strobus",
  "Pterocarya stenoptera","Quercus coccinea","Robinia x ambigua","Salix babylonica","Salix matsudana","Taxodium distichum","Thuja orientalis",
  "Thujopsis dolabrata","Tilia dasystyla","Zelkova serrata","Quercus macranthera","Tilia x moltkei"
]);
const UNCLEAR_SPECIES = new Set([
  "0_UNBESTIMMT","Unbekannt","Eco Arbore","Malus Hybride","Prunus Frühe Zierkirsche","Ulmus","Acer x","Aesculus hybrida",
  "Magnolia","Ulmus New Horizon","Malus domestica","Prunus domestica","Pyrus communis","Pyrus communis var. sativa","Prunus cerasifera",
  "Prunus persica","Prunus armeniaca","Cydonia oblonga","Mespilus germanica","Prunus fruticosa","Salix x sepulcralis"
]);
...
function nativeInfo(sp){
  ...
  const n=normalizeSpeciesName(raw);
  if(!raw || raw.startsWith("0_") || raw.toLowerCase().includes("unbekannt") || UNCLEAR_SPECIES.has(raw) || UNCLEAR_SPECIES.has(n)) return {status:"unclear",label:"Unklar",color:TEXT_MUTE};
  if(NATIVE_SPECIES.has(raw) || NATIVE_SPECIES.has(n)) return {status:"native",label:"Einheimisch",color:GREEN};
  // Eindeutige Kultivare einheimischer Arten werden der Art zugeordnet.
  if(["Acer platanoides","Fagus sylvatica","Tilia cordata","Fraxinus excelsior","Picea abies","Pinus nigra"].some(prefix=>raw.startsWith(prefix))){
    return prefixIsNative(raw);
  }
  if(NON_NATIVE_SPECIES.has(raw) || NON_NATIVE_SPECIES.has(n)) return {status:"non_native",label:"Nicht einheimisch",color:BRICK};
  return {status:"unclear",label:"Unklar",color:TEXT_MUTE};
}
function prefixIsNative(raw){
  if(raw.startsWith("Pinus nigra")) return {status:"non_native",label:"Nicht einheimisch",color:BRICK};
